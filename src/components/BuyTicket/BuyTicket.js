      ...
      <div className={classes.formContainer}>
        <div className={classes.form}>
          <Grid container spacing={2}>
            ...
            <Grid item xs={12}>
              <TextField label="Movie Name" variant="outlined" fullWidth />
            </Grid>
            <Grid item xs={12}>
              <TextField label="Email Address" variant="outlined" fullWidth />
            </Grid>
            <Grid item xs={12}>
              <TextField label="Card Number" variant="outlined" type='number' fullWidth />
            </Grid>
            <Grid item xs={12}>
              <TextField label="CCV Number" variant="outlined" type='number' fullWidth />
            </Grid>
            <Grid item xs={6}>
